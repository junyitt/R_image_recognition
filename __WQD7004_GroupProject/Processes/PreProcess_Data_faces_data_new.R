...
data_path <- file.path(getwd(), "Data/faces-data-new/images")
filtered_data_path <- file.path(getwd(), "Data/_TRAIN_faces-data-new")  
...
print("Completed: PreProcess_Data_faces_data_new.R")
