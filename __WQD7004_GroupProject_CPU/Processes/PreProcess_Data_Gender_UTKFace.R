data_path <- file.path(getwd(), "Data/UTKFace/UTKFace")
gender_data_path <- file.path(getwd(), "Data/_TRAIN_Gender_UTKFace")  
...
print("Completed: PreProcess_Data_Gender_UTKFace.R")
