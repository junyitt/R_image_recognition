# Train an Identity Recognition Model using CNN
...
# Replace last layer of the Model with 2 dense layers (for feature extractions) and 1 softmax output layer
...
# Save the Best Model and the relevant Metadata
